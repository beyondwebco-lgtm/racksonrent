...
export const SHOWCASE_CATEGORIES: ShowcaseCategory[] = [
  ...
  },
  {
    ...
    shortName: "Apparel",
    description: "Showcase gym clothing, performance wear, and branded merchandise inside high-footfall gyms.",
    suitableFor: ["Gym T-shirts", "Activewear", "Shorts", "Hoodies", "Tank tops", "Sports bras", "Leggings"],
    benefits: ["Daily visibility among gym members", "Direct access to active customers", "Lower retail-space cost", "Strong local brand discovery", "Flexible display formats"],
